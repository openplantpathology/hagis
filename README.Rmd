...
It was built to be useful for other plant pathogen gene-for-gene interaction systems, _e.g._, wheat rusts, but it has been used in animal science as well, [Cain _et al._ 2022](https://doi.org/10.1186/s13071-022-05533-y).
...
An updated version is available from from GitHub that still provides exactly the same results as the CRAN version but has minor differences in documentation and the code-base for maintenance.
