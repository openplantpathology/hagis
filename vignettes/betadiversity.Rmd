...
if (!have_required) {
  cat(
    "This vignette requires the **ape**, **vegan**, and **dplyr** packages, ",
    "which do not appear to be installed. The remainder of this vignette ",
