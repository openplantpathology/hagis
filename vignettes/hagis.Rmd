...
```{r}
#| label: pander-print-complexities
...
- Simple diversity index, which will show the proportion of unique pathotypes to total samples.
  ...
  Simple diversity is calculated as:
  $$
  D = \frac{Np}{Ns}
  $$
  where $Np$ is the number of pathotypes and $Ns$ is the number of samples.
...
- Evenness ranges from 0 to 1, as the Evenness value approaches 1, there is a more even distribution of each pathotype's frequency within the population.
  ...
  D = \frac{H'}{log(Np)}
  $$
  where $H'$ is the Shannon diversity index and $Np$ is the number of pathotypes.

```{r}
#| label: calculate-diversities
#| echo: true
